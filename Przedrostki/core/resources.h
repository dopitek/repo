...
#define PREFIX_MISSING "Nie podano przedrostka. Podaj przedrostek z opcja -p. Np. -p pre"
#define INPUT_FILE_NAME_MISSING "Nie podano pliku wejsciowego. Podaj plik wejsciowy z opcja -i. Np. -i plik_wejsciowy.txt"
#define INPUT_FILE_MISSING "Plik wejsciowy nie istnieje. Sprawdz nazwe pliku"
